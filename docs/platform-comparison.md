...
|---|---|---:|---:|---:|---:|---:|---:|
| [#24](https://github.com/Argentum-Astrum/vulntrack-api/actions/runs/29883052726) | новая staged CI; первый lint cache cold | ≈8 с | 18 с | 20 с | 24 с | 25 с | ≈103 с |
| [#27](https://github.com/Argentum-Astrum/vulntrack-api/actions/runs/29883765831) | hooks и secret scan; cache restored | ≈6 с | 29 с | 17 с | 19 с | 28 с | ≈109 с |
| [#30](https://github.com/Argentum-Astrum/vulntrack-api/actions/runs/29885192578) | docs/conflict PR; exact cache restored | ≈6 с | 13 с | 20 с | 20 с | 29 с | ≈99 с |
| **медиана трёх** | один workflow и runner image | **≈6 с** | **18 с** | **20 с** | **20 с** | **28 с** | **≈103 с** |

Cache state взят из logs, а не выведен из времени: первый lint run #24 не
имел restore и сохранил новый key; последующие jobs его восстановили. Run #27
содержит restore evidence, а все четыре mandatory jobs #30 восстановили один
точный dependency key. Эфемерность runner при этом не меняется.
...
Три GitHub-запуска — малая выборка одного публичного проекта. Медиана
